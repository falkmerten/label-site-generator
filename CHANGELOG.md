...
- Label names shown on album cards: `(CD, Digital — Aenaos Records)`
- Label names shown on album pages with Discogs link: `Released: 29 January 2021 · [Aenaos Records](https://www.discogs.com/label/...)`
- Discogs disambiguation numbers stripped from label names (e.g. `Melodika (3)` → `Melodika`)
